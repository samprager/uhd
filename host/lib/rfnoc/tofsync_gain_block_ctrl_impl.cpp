...
#include <uhd/rfnoc/tofsync_gain_block_ctrl.hpp>
#include <uhd/utils/log.hpp>

using namespace uhd::rfnoc;

class tofsync_gain_block_ctrl_impl : public tofsync_gain_block_ctrl
{
public:
    UHD_RFNOC_BLOCK_CONSTRUCTOR(tofsync_gain_block_ctrl),
    ...
    {
        UHD_LOGGER_TRACE(unique_id()) << "tofsync_gain::set_gain()" << std::endl;
...
UHD_RFNOC_BLOCK_REGISTER(tofsync_gain_block_ctrl, "TofsyncGain");
