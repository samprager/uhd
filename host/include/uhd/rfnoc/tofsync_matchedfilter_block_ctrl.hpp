...
#ifndef INCLUDED_LIBUHD_RFNOC_TOFSYNC_MATCHEDFILTER_BLOCK_CTRL_HPP
#define INCLUDED_LIBUHD_RFNOC_TOFSYNC_MATCHEDFILTER_BLOCK_CTRL_HPP
 ...
 */
class UHD_RFNOC_API tofsync_matchedfilter_block_ctrl : public source_block_ctrl_base,
                                        public sink_block_ctrl_base
{
public:
    UHD_RFNOC_BLOCK_OBJECT(tofsync_matchedfilter_block_ctrl)
    ...
    virtual void set_ref_waveform(const std::vector<boost::uint32_t> &samples) = 0;
    virtual void set_ref_waveform(const std::vector<boost::uint32_t> &samples, int spp) = 0;
    virtual boost::uint64_t get_fractional_peak() = 0;
    virtual boost::uint64_t get_user_register(boost::uint32_t addr) = 0;
...
}; /* class tofsync_matchedfilter_block_ctrl*/

}} /* namespace uhd::rfnoc */

#endif /* INCLUDED_LIBUHD_RFNOC_tofsync_matchedfilter_block_ctrl_HPP */
