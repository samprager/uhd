...
#ifndef INCLUDED_LIBUHD_RFNOC_TOFSYNC_GAIN_BLOCK_CTRL_HPP
#define INCLUDED_LIBUHD_RFNOC_TOFSYNC_GAIN_BLOCK_CTRL_HPP
 ...
 */
class UHD_RFNOC_API tofsync_gain_block_ctrl : public source_block_ctrl_base,
                                        public sink_block_ctrl_base
{
public:
    UHD_RFNOC_BLOCK_OBJECT(tofsync_gain_block_ctrl)
...
}; /* class tofsync_gain_block_ctrl*/

}} /* namespace uhd::rfnoc */

#endif /* INCLUDED_LIBUHD_RFNOC_tofsync_gain_block_ctrl_HPP */
